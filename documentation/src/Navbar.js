...
const Navbar = (props) => {
    ...
    return (
        <nav class="navbar navbar-expand-md bg-light sticky-top navbar-shrink py-2" id="mainNav">
            <div class="container-fluid"><a class="navbar-brand d-flex align-items-center mt-0 mb-0" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary  d-flex justify-content-center align-items-center me-2 bs-icon"><img src={require('./music.png')} alt="" srcset="" height='45px' width='' /></span></a>
